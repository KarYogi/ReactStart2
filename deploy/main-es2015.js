...
let CarService = class CarService {
    ...
    getAll() {
        return this.http.get(`${this.baseUrl}/api/list.php`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
            this.cars = res['data'];
            return this.cars;
...
module.exports = __webpack_require__(/*! /Users/karthik/Merchants2/src/main.ts */"./src/main.ts");
